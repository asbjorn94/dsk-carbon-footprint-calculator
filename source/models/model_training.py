...
def train_model():
    ...
    base_dir = "source/models/" #TODO: Find better solution for relative file handling
    path = Path(base_dir + "danish_ingredient_pairs_manual.csv")
    ...
    args = SentenceTransformerTrainingArguments(
        # Required parameter:
        output_dir= str(Path(base_dir + "sentence-transformer-models/all-MiniLM-L6-v2-finetuned-DK-ingredients")),
    ...
    base_model.save_pretrained(str(Path(base_dir + "sentence-transformer-models/all-MiniLM-L6-v2-finetuned-DK-ingredients/final")))
